...
readonly NAMESPACE="20260722_case78_shadow_label_measurement_v1_exclusive"
...
readonly CONTRACT="$ROOT/scripts/two_wheel_balance/case78_shadow_label_runtime_authorization_v1.json"
readonly VALIDATOR="$ROOT/scripts/two_wheel_balance/validate_case78_shadow_label_runtime_authorization.py"
readonly PLAYBACK="${WIN_ROOT}\\scripts\\two_wheel_balance\\smoke_riser_reference_playback.py"
readonly SUMMARIZER="${WIN_ROOT}\\scripts\\two_wheel_balance\\summarize_case78_shadow_label_measurement.py"
...
for variable in RISER_ROOT RISER_WIN_ROOT ISAAC_PYTHON \
  RISER_CASE78_SHADOW_AUTHORIZATION_FILE RISER_CASE78_SHADOW_NAMESPACE \
  RISER_CASE78_SHADOW_CONTRACT RISER_CASE78_SHADOW_PLAN \
  RISER_CASE78_SHADOW_OUTPUT RISER_CASE78_SHADOW_TIMEOUT \
  RISER_CASE78_SHADOW_HEARTBEAT RISER_CASE78_SHADOW_ACTION_SCALES; do
...
AUTHORIZATION_FILE="${RISER_CASE78_SHADOW_AUTHORIZATION_FILE:-}"
...
mkdir -p "$OUTPUT/gates" "$OUTPUT/traces" "$OUTPUT/logs"
