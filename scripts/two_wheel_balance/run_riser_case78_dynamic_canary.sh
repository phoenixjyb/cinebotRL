...
readonly NAMESPACE="20260721_case78_dynamic_qualification_v1_exclusive"
...
readonly CONTRACT="$ROOT/scripts/two_wheel_balance/case78_runtime_authorization_v1.json"
readonly VALIDATOR="$ROOT/scripts/two_wheel_balance/validate_riser_case78_runtime_authorization.py"
readonly PLAYBACK="${WIN_ROOT}\\scripts\\two_wheel_balance\\smoke_riser_reference_playback.py"
readonly SUMMARIZER="${WIN_ROOT}\\scripts\\two_wheel_balance\\"\
"summarize_riser_case78_dynamic_canary.py"
readonly PLAN_DIR="${WIN_ROOT}\\artifacts\\two_wheel_riser\\"\
"20260720_smoothed_plan_all79_v16_case36_explicit_preview055_g125_cpu"
readonly GAINS="${WIN_ROOT}\\docs\\03_training\\two_wheel_balance\\"\
