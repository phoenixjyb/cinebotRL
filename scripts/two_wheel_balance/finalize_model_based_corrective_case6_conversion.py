#!/usr/bin/env python3
"""Reopen and seal one authorized case-6 corrective case conversion."""
...
SCHEMA = "cinebotrl_two_wheel_riser_case6_conversion_final_v1"
ADMISSION_SCHEMA = (
...
DATASET_NAME = "case_0006_model_based_corrective_case_dataset_v1.npz"
...
def finalize(
    ...
    *,
    ...
    conversion_result: dict[str, object] = {}
    ...
    if checks["dataset_loaded"]:
        ...
        checks.update(
            {
                "source_capture_hash": metadata.get("source_capture_sha256")
