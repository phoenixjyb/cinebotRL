#!/usr/bin/env python3
"""Validate the fresh no-token case-23 corrective-label capture v3 preflight."""
...
REVIEWED_PARENT = "f444c7b88d84f66acf6857fff759ee618a7f633b"
NAMESPACE = "20260723_model_based_corrective_teacher_case23_capture_v3_exclusive"
