#!/usr/bin/env python3
"""Validate the no-token paired case-30 corrective-teacher preflight."""
...
ADMISSION_SCHEMA = (
    "cinebotrl_two_wheel_riser_corrective_teacher_case30_pair_admission_v1"
)
REVIEWED_PARENT = "cc3db43c30b719389b47b38e7b44b1ac1d085c72"
NAMESPACE = "20260722_model_based_corrective_teacher_case30_pair_v1_exclusive"
CONTRACT_RELATIVE_PATH = (
    "scripts/two_wheel_balance/"
    "model_based_corrective_teacher_case30_pair_contract_v1.json"
)
...
def validate(
    ...
    *,
    ...
    proposal_checks = {
        ...
        == "cinebotrl_two_wheel_riser_corrective_teacher_proposal_v1",
        "case_split": proposal.get("candidate_case") == 30
        and proposal.get("candidate_split") == "train",
        "pair_contract": proposal.get("paired_admission_contract")
        == "same_seed_paired_dynamic_improvement_before_label_capture_v1",
        "holdout_closed": proposal.get("holdout_cases") == EXPECTED_HOLDOUT
        and proposal.get("validation_cases_opened") == [],
        "runtime_closed": proposal.get("runtime_authorized") is False
    ...
    corrective_profile_checks = {
        ...
        "case": corrective_profile.get("case") == 30,
    ...
    perturbation_checks = {
        ...
        "case": perturbation_profile.get("case") == 30,
