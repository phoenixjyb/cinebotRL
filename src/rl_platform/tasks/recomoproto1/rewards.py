"""Reward and penalty terms for RecomoProto1 manipulator tracking."""
...
def collision_penalty(
    ...
    DEPRECATED: Use self_collision_penalty for RecomoProto1 manipulators.
...
def self_collision_penalty(
    ...
    critical to prevent for RecomoProto1 manipulators (arm hitting base, etc.).
...
def compute_combined_reward(
    ...
    # Safety penalties - SELF-COLLISION (critical for RecomoProto1 manipulator!)
