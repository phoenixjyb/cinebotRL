#!/usr/bin/env python3
"""Seal one heartbeat-enabled case-78 camera-recovery canary."""
...
def summarize(
    ...
    *,
    ...
    gate_contract_checks = {
        ...
        == EXECUTION_DURATION_S,
        "recovery_governor_enabled": gate.get(
            "camera_recovery_governor_enabled"
        )
        is True
        and result.get("camera_recovery_governor_enabled") is True,
        "recovery_range_exact": gate.get("camera_recovery_error_range_m")
        == [0.13, 0.155]
        ...
        "recovery_telemetry_observed": result.get(
    ...
    return {
        "schema": "cinebotrl_two_wheel_riser_case78_camera_recovery_final_v1",
