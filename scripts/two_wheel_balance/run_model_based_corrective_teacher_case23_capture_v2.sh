...
readonly NAMESPACE="20260723_model_based_corrective_teacher_case23_capture_v2_exclusive"
readonly CONTRACT="$ROOT/scripts/two_wheel_balance/model_based_corrective_teacher_case23_capture_contract_v2.json"
readonly VALIDATOR="$ROOT/scripts/two_wheel_balance/validate_model_based_corrective_teacher_case23_capture_v2.py"
...
for variable in RISER_ROOT RISER_WIN_ROOT ISAAC_PYTHON \
  RISER_CORRECTIVE_CASE23_CAPTURE_V2_NAMESPACE \
  RISER_CORRECTIVE_CASE23_CAPTURE_V2_CONTRACT \
  RISER_CORRECTIVE_CASE23_CAPTURE_V2_OUTPUT; do
