...
from scripts.two_wheel_balance.validate_riser_case78_runtime_authorization_v2 import (
    AUTHORIZATION,
    token_checks,
)
...
def test_v2_exact_mode_0600_token_passes(tmp_path: Path) -> None:
...
def test_v2_forged_token_fails_closed(tmp_path: Path) -> None:
    token = tmp_path / "authorization"
