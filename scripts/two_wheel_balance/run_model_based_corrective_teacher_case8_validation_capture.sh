...
readonly NAMESPACE="20260728_model_based_corrective_teacher_case8_validation_capture_v1_coexistence"
readonly CONTRACT="$SCRIPT_DIR/model_based_corrective_teacher_case8_validation_capture_contract_v1.json"
readonly VALIDATOR="$SCRIPT_DIR/validate_model_based_corrective_teacher_case8_validation_capture.py"
...
readonly FINALIZER="$WIN_ROOT\\scripts\\two_wheel_balance\\summarize_model_based_corrective_teacher_case8_validation_capture.py"
...
for variable in RISER_ROOT RISER_WIN_ROOT ISAAC_PYTHON \
  RISER_CORRECTIVE_CASE8_VALIDATION_CAPTURE_NAMESPACE \
  RISER_CORRECTIVE_CASE8_VALIDATION_CAPTURE_CONTRACT \
  RISER_CORRECTIVE_CASE8_VALIDATION_CAPTURE_OUTPUT; do
...
AUTHORIZATION_FILE="${RISER_CORRECTIVE_CASE8_VALIDATION_CAPTURE_AUTHORIZATION_FILE:-}"
AUTHORIZATION_SHA256="${RISER_CORRECTIVE_CASE8_VALIDATION_CAPTURE_AUTHORIZATION_SHA256:-}"
...
setsid timeout --signal=TERM --kill-after=30s 600 \
  ...
  --output "$OUTPUT_WIN\\case_0008.json" \
  --headless \
