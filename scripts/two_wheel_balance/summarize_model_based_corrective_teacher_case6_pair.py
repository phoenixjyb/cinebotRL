#!/usr/bin/env python3
"""Seal one paired case-6 baseline/corrective-teacher canary."""
...
def summarize(
    ...
    *,
    ...
    baseline_path = root / "baseline/case_0006.json"
    candidate_path = root / "candidate/case_0006.json"
    ...
    plan_sha = identities.get("case6_plan", {}).get("sha256")
    ...
    rollout_checks = {
        ...
        "baseline_single_case": baseline.get("cases") == [6]
        and baseline_result.get("case") == 6,
        "candidate_single_case": candidate.get("cases") == [6]
        and candidate_result.get("case") == 6,
        ...
        is False,
        "baseline_heartbeat": baseline_heartbeat.get("case") == 6
        and int(baseline_heartbeat.get("completed_steps", 0)) > 0,
        "candidate_heartbeat": candidate_heartbeat.get("case") == 6
    ...
    contract_checks = {
        ...
        "case_split": contract.get("case") == 6 and split == "train",
    ...
    return {
        "schema": "cinebotrl_two_wheel_riser_corrective_teacher_case6_pair_final_v2",
