...
readonly NAMESPACE="20260728_model_based_corrective_teacher_case16_validation_natural_error_pair_v2_coexistence"
...
AUTHORIZATION_SHA256="${RISER_CORRECTIVE_CASE16_VALIDATION_AUTHORIZATION_SHA256:-}"
