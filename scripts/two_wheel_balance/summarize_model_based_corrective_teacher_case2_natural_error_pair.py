#!/usr/bin/env python3
"""Seal one paired case-2 natural-error corrective canary."""
...
def _projection_closed(
    ...
    return bool(
        ...
        and telemetry.get("training_started") is False
    )
...
def summarize(
    ...
    *,
    ...
    baseline_path = root / "baseline/case_0002.json"
    candidate_path = root / "candidate/case_0002.json"
    ...
    plan_sha = identities.get("case2_plan", {}).get("sha256")
    ...
    rollout_checks = {
        ...
        "baseline_single_case": baseline.get("cases") == [2]
        and baseline_result.get("case") == 2,
        "candidate_single_case": candidate.get("cases") == [2]
        and candidate_result.get("case") == 2,
        ...
        is False,
        "baseline_heartbeat": baseline_heartbeat.get("case") == 2
        and int(baseline_heartbeat.get("completed_steps", 0)) > 0,
        "candidate_heartbeat": candidate_heartbeat.get("case") == 2
    ...
    contract_checks = {
        ...
        "case_split": contract.get("case") == 2 and split == "train",
    ...
    return {
        "schema": (
            ...
            "case2_natural_error_pair_final_v1"
        ),
