...
readonly CONTRACT="$ROOT/scripts/two_wheel_balance/case78_runtime_authorization_v2.json"
readonly VALIDATOR="$ROOT/scripts/two_wheel_balance/validate_riser_case78_runtime_authorization_v2.py"
readonly PLAYBACK="${WIN_ROOT}\\scripts\\two_wheel_balance\\smoke_riser_reference_playback.py"
readonly SUMMARIZER="${WIN_ROOT}\\scripts\\two_wheel_balance\\summarize_riser_case78_dynamic_canary_v2.py"
