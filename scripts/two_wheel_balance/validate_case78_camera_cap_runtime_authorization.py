#!/usr/bin/env python3
"""Validate one-use case-78 camera-cap runtime authorization."""
...
try:
    from .validate_case78_camera_cap_contract import validate as validate_cpu
...
AUTHORIZATION = "AUTHORIZED_CASE78_CAMERA_CAP_CANARY_V1"
REQUIRED_IDENTITIES = {
    "cpu_contract",
    "runtime_summarizer",
    "runtime_validator",
...
def validate(
    ...
    *,
    ...
    checks = {
        ...
        "camera_cap_scope": contract.get("camera_recovery_governor_required")
        is False
        and contract.get("maximum_camera_lever_arm_correction_m") == 0.10,
    ...
    return {
        "schema": "cinebotrl_two_wheel_riser_case78_camera_cap_runtime_admission_v1",
