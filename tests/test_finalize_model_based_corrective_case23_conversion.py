...
SPEC = importlib.util.spec_from_file_location("case23_conversion_finalizer", SCRIPT)
...
def test_finalizer_reopens_and_seals_case23_dataset(tmp_path) -> None:
    ...
    assert result["metrics"]["sample_count"] == 3273
