#!/usr/bin/env python3
"""Validate the fail-closed case-32 natural-error validation pair route."""
...
SCHEMA = (
    "cinebotrl_two_wheel_riser_corrective_teacher_case32_validation_"
...
REVIEWED_PARENT = "da20ebb9158a9251e3919f3e6b04032c17827afe"
NAMESPACE = (
...
CONTRACT_RELATIVE_PATH = (
    ...
    "case32_validation_natural_error_pair_contract_v1.json"
)
EXPECTED_SELECTED = [8, 32]
...
EXPECTED_PAIR_CONTRACT = {
    ...
    "candidate": (
        "complete_model_based_planner_plus_case32_validation_"
    ...
    *,
    ...
    case_row = next(
        (
            ...
            if isinstance(row, Mapping) and row.get("case") == 32
        ),
        {},
    )
    ...
    document_checks = {
        ...
        is True
        and readiness.get("case8_profile_reuse_authorized") is False
        and readiness.get("case16_profile_reuse_authorized") is False
        ...
        "corrective": corrective.get("case") == 32
