#!/usr/bin/env python3
"""Validate one-use heartbeat-enabled case-78 runtime authorization."""
...
try:
    ...
    from .validate_riser_case78_dynamic_contract_v2 import validate as validate_cpu
except ImportError:
    from validate_riser_case78_dynamic_contract import git, identity_row, sha256_file
    from validate_riser_case78_dynamic_contract_v2 import validate as validate_cpu
...
AUTHORIZATION = "AUTHORIZED_CASE78_HEARTBEAT_CANARY_V2"
REQUIRED_IDENTITIES = {
    "cpu_contract",
    "runtime_summarizer",
    "runtime_validator",
...
def validate(
    ...
    *,
    ...
    checks = {
        ...
        "heartbeat_scope": contract.get("heartbeat_required") is True
    ...
    return {
        "schema": "cinebotrl_two_wheel_riser_case78_runtime_admission_v2",
