...
readonly NAMESPACE="20260722_case78_camera_cap_v1_exclusive"
...
readonly CONTRACT="$ROOT/scripts/two_wheel_balance/case78_camera_cap_runtime_authorization_v1.json"
readonly VALIDATOR="$ROOT/scripts/two_wheel_balance/validate_case78_camera_cap_runtime_authorization.py"
readonly PLAYBACK="${WIN_ROOT}\\scripts\\two_wheel_balance\\smoke_riser_reference_playback.py"
readonly SUMMARIZER="${WIN_ROOT}\\scripts\\two_wheel_balance\\summarize_case78_camera_cap_canary.py"
...
for variable in RISER_ROOT RISER_WIN_ROOT ISAAC_PYTHON RISER_CASE78_NAMESPACE \
  ...
  RISER_CASE78_TIMEOUT RISER_CASE78_HEARTBEAT RISER_CASE78_CAMERA_CAP; do
...
AUTHORIZATION_FILE="${RISER_CASE78_CAMERA_CAP_AUTHORIZATION_FILE:-}"
