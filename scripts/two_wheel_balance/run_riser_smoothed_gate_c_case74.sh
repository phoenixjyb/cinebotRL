...
AUTHORIZATION="AUTHORIZED_RISER_SMOOTHED_GATE_C_CASE74_RELIEF_WZKP090_V4"
CASE=74
STAMP="20260718_gate_c_smoothed_case74_relief_wzkp090_v4_exclusive"
...
ok = (
    gate.get("cases") == [74]
    and gate.get("controller_overrides") == {"wz_kp": 0.9}
