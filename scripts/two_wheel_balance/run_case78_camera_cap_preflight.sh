...
readonly CONTRACT_RELATIVE="scripts/two_wheel_balance/case78_camera_cap_cpu_contract_v1.json"
...
import sys
print(json.dumps({
    "schema": "cinebotrl_two_wheel_riser_case78_camera_cap_rejection_v1",
    "reason": sys.argv[1],
    "case": 78,
...
VALIDATOR="$SCRIPT_DIR/validate_case78_camera_cap_contract.py"
