#!/usr/bin/env python3
"""Validate the CPU-only, fail-closed case-7 corrective pair contract."""
...
SCHEMA = "cinebotrl_two_wheel_riser_corrective_teacher_case7_pair_contract_v1"
ADMISSION_SCHEMA = (
    "cinebotrl_two_wheel_riser_corrective_teacher_case7_pair_admission_v1"
)
REVIEWED_PARENT = "e5cc7bcda65bf6f51a6f1439dc93c49cb0b8479c"
NAMESPACE = "20260724_model_based_corrective_teacher_case7_pair_v1_exclusive"
...
EXPECTED_PAIR_CONTRACT = {
    ...
    "candidate": "complete_model_based_planner_plus_case7_corrective_teacher",
...
EXPECTED_AUTHORIZATION_SHA256 = (
    "c9a19cfaa1bb5f518bde8c2223ef0cfe6bfc87099e5daa7f7acc90f37b7bae9d"
)
    ...
    *,
    ...
    selected_case7 = next(
        (
            ...
            if isinstance(row, dict) and row.get("case") == 7
        ),
        {},
    )
    ...
    selection_checks = {
        ...
        "case7_requires_pair": selected_case7.get("selection_role")
        == "same_seed_paired_canary_required",
        "plan_bound": selected_case7.get("plan_sha256")
        == identities.get("case7_plan", {}).get("sha256"),
    ...
    proposal_checks = {
        ...
        "effective_label_projection": proposal.get("projection_envelope", {}).get(
            "label_contract"
        )
        == "effective_post_supervisor_residual_only"
        and proposal.get("projection_envelope", {})
        .get("pulse_window", {})
        .get("all_requested_commands_unclipped")
        is True
        and proposal.get("projection_envelope", {})
        .get("full_plan", {})
        .get("directions", {})
        .get("negative", {})
        .get("command_clipped_transition_count")
        == [0, 0, 4]
        and proposal.get("projection_envelope", {}).get(
    ...
    perturbation_checks = {
        ...
        "case": perturbation.get("case") == 7,
        "phase": perturbation.get("start_phase_time_s") == 2.851306269086607,
    ...
    checks = {
        ...
        "case_is_7_train": contract.get("case") == 7
