#!/usr/bin/env python3
"""Seal one paired case-30 baseline/corrective-teacher canary."""
...
def summarize(
    ...
    *,
    ...
    baseline_path = root / "baseline/case_0030.json"
    candidate_path = root / "candidate/case_0030.json"
    ...
    rollout_checks = {
        ...
        "baseline_single_case": baseline.get("cases") == [30]
        and baseline_result.get("case") == 30,
        "candidate_single_case": candidate.get("cases") == [30]
        and candidate_result.get("case") == 30,
        ...
        is False,
        "baseline_heartbeat": baseline_heartbeat.get("case") == 30
        and int(baseline_heartbeat.get("completed_steps", 0)) > 0,
        "candidate_heartbeat": candidate_heartbeat.get("case") == 30
    ...
    contract_checks = {
        ...
        "case_split": contract.get("case") == 30 and split == "train",
