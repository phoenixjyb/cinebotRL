...
- GPU Memory: 5-7GB (25%)
- Speed: 40K steps/sec
- Training Time: 15-20 mins per run
...
```
- GPU: 5-7GB (25%), Speed: 40K steps/sec, Time: 15-20 mins

### Phase 2: Aggressive (4-6x faster)
```powershell
--num_envs 4096 --batch_size 2048 --n_steps 4096
```
- GPU: 10-15GB (60%), Speed: 80-120K steps/sec, Time: 5-10 mins

### Phase 3: Maximum (6-8x faster)
```powershell
--num_envs 6144 --batch_size 4096 --n_steps 4096
```
- GPU: 18-22GB (80%), Speed: 120-160K steps/sec, Time: 3-5 mins
