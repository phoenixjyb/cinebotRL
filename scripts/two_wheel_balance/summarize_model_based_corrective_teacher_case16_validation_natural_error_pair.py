#!/usr/bin/env python3
"""Seal one case-16 natural-error held-out validation pair."""
...
from summarize_model_based_corrective_teacher_case2_natural_error_pair import (  # noqa: E402
    EXPECTED_SCALES,
    EXPECTED_SOURCES,
    _capture_closed,
    _identity,
...
def summarize(
    ...
    *,
    ...
    baseline_path = root / "baseline/case_0016.json"
