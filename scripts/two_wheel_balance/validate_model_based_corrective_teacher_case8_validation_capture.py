...
def validate(
    ...
    *,
    ...
    checks = {
        ...
        "case_split": contract.get("case") == 8
        ...
        "plan_identity": identities.get("case8_plan", {}).get("sha256")
        ...
        and contract.get("validation_cases_opened") == [8],
    ...
    return {
        ...
        "plan_sha256": identities.get("case8_plan", {}).get("sha256"),
