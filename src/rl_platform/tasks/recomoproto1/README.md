# RecomoProto1 manipulator End-Effector Tracking Task

## Overview

The `RecomoProto1TrackEE-v0` task trains a RecomoProto1 manipulator to track a reference trajectory with its end-effector while maintaining stability and avoiding obstacles.
...
```python
from rl_platform.tasks.recomoproto1 import RecomoProto1TrackEEEnvCfg
from rl_platform.tasks.recomoproto1.config import RecomoProto1TrackConfig, TrajectoryConfig, RewardWeights

# Create custom configuration
task_config = RecomoProto1TrackConfig(
...
cfg = RecomoProto1TrackEEEnvCfg(task_config=task_config)
```
