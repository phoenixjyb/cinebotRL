#!/usr/bin/env python3
"""Seal one paired case-7 baseline/corrective-teacher canary."""
...
def summarize(
    ...
    *,
    ...
    baseline_path = root / "baseline/case_0007.json"
    candidate_path = root / "candidate/case_0007.json"
    ...
    plan_sha = identities.get("case7_plan", {}).get("sha256")
    ...
    rollout_checks = {
        ...
        "baseline_single_case": baseline.get("cases") == [7]
        and baseline_result.get("case") == 7,
        "candidate_single_case": candidate.get("cases") == [7]
        and candidate_result.get("case") == 7,
        ...
        is False,
        "baseline_heartbeat": baseline_heartbeat.get("case") == 7
        and int(baseline_heartbeat.get("completed_steps", 0)) > 0,
        "candidate_heartbeat": candidate_heartbeat.get("case") == 7
    ...
    contract_checks = {
        ...
        "case_split": contract.get("case") == 7 and split == "train",
    ...
    return {
        "schema": "cinebotrl_two_wheel_riser_corrective_teacher_case7_pair_final_v1",
